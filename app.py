...
# 6. Main Interface
st.title("Emotion-Aware AI Writing Assistant and Dynamic Visual Storytelling Support")
...
prompt = st.text_area("Prompt", value=st.session_state.current_prompt, height=100)
